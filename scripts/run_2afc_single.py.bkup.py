...
if __name__ == "__main__":
    ...
    # Set up arguments as sys.argv instead of calling main() directly
    import sys
    
    data_path = "G:\\To Process\\PMA17\\PMA17 2020-10-22 Session-1\\Analysis\\LFADS\\PMA17_20201022_Session1.h5" 
    output_dir = "G:\\To Process\\PMA17\\PMA17 2020-10-22 Session-1\\Analysis\\LFADS\\results"
    config_name = "2afc_single"
    max_epochs = 200 
    factor_dim = 50 
    gen_dim = 128 
    batch_size = 64
